...
public interface PacienteDAO {
	...
	public static final String FIND_CITAS_POR_DIA = FIND_CITAS_SQL + " AND FROM_UNIXTIME(C.STARTDATE/1000) >= ? AND FROM_UNIXTIME(C.ENDDATE /1000) < ? ORDER BY  C.STARTDATE ASC ";
