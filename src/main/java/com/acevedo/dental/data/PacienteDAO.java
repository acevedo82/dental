...
public interface PacienteDAO {
	...
	public static final String FIND_CITAS_EN_90_DIAS_SQL = FIND_CITAS_SQL + " AND (FROM_UNIXTIME(C.STARTDATE/1000) > (NOW() - INTERVAL 28 DAY)) AND (FROM_UNIXTIME(C.STARTDATE/1000) < (NOW() + INTERVAL 360 DAY))";
