...
INSERT INTO TRATAMIENTOS(TRATAMIENTO, DURACION, COSTO) VALUES ('COLOCACION ORTODONCIA', 60, 800);
...
INSERT INTO TRATAMIENTOS(TRATAMIENTO, DURACION, COSTO) VALUES ('PROFILAXIS', 60, 800);
INSERT INTO TRATAMIENTOS(TRATAMIENTO, DURACION, COSTO) VALUES ('DIAGNOSTICO DE ORTOPEDIA', 60, 800);
...
insert into cita(id_paciente, id_tratamiento, startdate, endDate, notas) values(1,1,UNIX_TIMESTAMP(NOW())*1000, UNIX_TIMESTAMP(NOW()+INTERVAL 30 MINUTE)*1000, "NOTAS 1");
insert into cita(id_paciente, id_tratamiento, startdate, endDate, notas) values(1,3,UNIX_TIMESTAMP(NOW()+ INTERVAL 30 MINUTE)*1000, UNIX_TIMESTAMP(NOW()+INTERVAL 60 MINUTE)*1000, "NOTAS 1");
insert into cita(id_paciente, id_tratamiento, startdate, endDate, notas) values(2,5,UNIX_TIMESTAMP(NOW()+ INTERVAL 60 MINUTE)*1000, UNIX_TIMESTAMP(NOW()+INTERVAL 90 MINUTE)*1000, "NOTAS 2");
insert into cita(id_paciente, id_tratamiento, startdate, endDate, notas) values(2,7,UNIX_TIMESTAMP(NOW()+ INTERVAL 90 MINUTE)*1000, UNIX_TIMESTAMP(NOW()+INTERVAL 120 MINUTE)*1000, "NOTAS 3");
insert into cita(id_paciente, id_tratamiento, startdate, endDate, notas) values(3,9,UNIX_TIMESTAMP(NOW()+ INTERVAL 120 MINUTE)*1000, UNIX_TIMESTAMP(NOW()+INTERVAL 150 MINUTE)*1000, "NOTAS 4");
insert into cita(id_paciente, id_tratamiento, startdate, endDate, notas) values(3,11,UNIX_TIMESTAMP(NOW()- INTERVAL 150 MINUTE)*1000, UNIX_TIMESTAMP(NOW()+INTERVAL 180 MINUTE)*1000, "NOTAS 5");
